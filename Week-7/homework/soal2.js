...
// membuat variable data untuk menyimpan data log
...
// menggunakan fungsi fs.writeFile untuk menulis file pada file log.txt
fs.writeFile("log.txt", data, (err) => {
  err ? console.log(err) : console.log("sukses menulis file");
});

// menggunakan fungsi fs.readFile untuk membaca file pada file log.txt
